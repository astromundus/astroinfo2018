...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lhead{ASTROINFORMATICS: Introduction to AstroStatistics and Big Data in Astronomy}
\rhead{FALL 2018}
...
\vskip 0.3in
\leftline{{\bf  Location and Time:} Tuesdays 17:00-19:00, {\bf AOB Library}}

\vskip 0.2in
\leftline{{\bf  Office Hours:} { Any time when my office door is open; }}
\leftline{\hskip 1.15in After class is the best - ping me via e-mail.}
\vskip 0.2in
\leftline{{\bf  Grading:} 8-10 homeworks, 80\% ; final exam: 20\%}
\leftline{                 \hskip 0.8in key: $>$85\%=10, $>$75\%=9, $>$65\%=8,
  $>$55\%=7,  $>$45\%=6 .}
\vskip 0.2in
\leftline{{\bf  Class web site:} https://github.com/astromundus/astroinfo2018}
\vskip 0.2in
